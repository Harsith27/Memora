...
- Azure OneDeploy can occasionally report a failed deployment status even when Oryx build output has zero issues and the app is healthy.
- Always treat endpoint health checks as final go/no-go before rollback.
