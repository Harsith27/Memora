...
export default function WhatIsMemora() {
  return (
    <div>
      <h2 className="text-2xl font-semibold text-sky-600 mb-4">What is Memora?</h2>
      ...
      <h3 className="text-lg font-semibold text-sky-600 mb-3">Core ideas</h3>
      ...
      <h3 className="text-lg font-semibold text-sky-600 mb-3">Getting started</h3>
